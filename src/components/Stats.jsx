    ...
    <div className="grid grid-cols-2 ">
        <StatCard lg title="Active Caffiene Level"> 
          <div className="flex gap-2  items-center" >
            ...
            <h5 className={" p-2 rounded-md w-12 text-center mt-2 " + (warningLevel === 'low' ? 'text-green-400 bg-green-700': warningLevel === 'moderate' ? 'text-orange-300 bg-orange-500 pr-4' : 'text-red-300 bg-red-600')}>{warningLevel}</h5>
          </div>
